...
![](https://github.com/JiayingLi0803/StrugglingLeetCode/blob/main/Figures/Problem54_1.jpeg)
```
...
![](https://github.com/JiayingLi0803/StrugglingLeetCode/blob/main/Figures/Problem54_2.jpeg)
```
...
class Solution:
    def spiralOrder(self, matrix: List[List[int]]) -> List[int]:
        ...
        return result
```
**Approach 2: Mark Visited Points**
```
class Solution:
    def spiralOrder(self, matrix: List[List[int]]) -> List[int]:
        VISITED = 101
